module.exports = {
  ...
  operation_tips: {
    ...
    tips_68: '进入页面',
    tips_69: '完成',
    tips_70: '步骤1：进入页面设置部门信息。',
    tips_71: '步骤2：点击《添加》按钮添加部门信息。',
    tips_72: '步骤3：添加工作分类。',
    tips_73: '步骤4：进入页面添加设备。',
    tips_74: '步骤5：点击《添加设备》进行手动输入IP地址添加设备。',
    tips_75:
      '步骤6：或者点击《搜索设备》进行自动搜索，然后点击《添加》按钮添加设备。',
    tips_76: '步骤7：进入页面设置考勤信息。',
    tips_77: '步骤8：点击《新增》按钮添加考勤班次。',
    tips_78: '步骤9：进入页面设置考勤组信息。',
    tips_79: '步骤10：点击《新增》按钮添加考勤班次。',
    tips_80: '步骤11：进入页面设置人员信息。',
    tips_81: '步骤12：点击《新增》按钮添加单个人员信息。',
    tips_82: '步骤13：点击《下载模板》按钮获取批量导入模板。',
    tips_83: '步骤14：点击《批量导入》按钮批量添加人员信息。',
  },
  // 首页
  home: {
    text_1: '注册人数',
  ...
  system: {
    ...
    text_9: 'ID下发',
    text_10:
      '<编号下发>时新增人员编号必须填写为中华人民共和国居民身份证公民身份号码（身份证号）',
