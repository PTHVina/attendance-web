module.exports = {
  ...
  operation_tips: {
    ...
    tips_3: '请输入正确的11位电话号码, 多个号码请用英文逗号隔开',
    tips_4: '你确定要删除当前项吗?',
    tips_5: '删除失败!',
    tips_6: '删除成功!',
    tips_7: '获取编码失败!',
  ...
  accessControl: {
    ...
    addEmployeeTypeDeployRule: '添加人员类别下发规则',
    addDepartmentDeployRule: '添加组织机构下发规则',
    addEmployeeDeployRule: '添加人员下发规则',
    generateDeployTask: '生成下发任务',
    personDepartmentEmployeeType: '人员/组织机构/人员类别',
    device: '设备',
    rule: '规则',
    ...
    note1:
      '1.调度规则用于定义已下发人员的通行时间，一条下发规则中设备匹配上的人员只能在定义时间内通行。',
    note2:
      '2.优先添加人员类别下发规则，其次组织机构下发规则，最后人员下发规则。从前到后，人员下发规则优先级最高！',
    note3:
      '3.对于组织机构下发规则，不会查找该组织机构的上下级组织机构的从属关系！即某个员工属于A组织机构，那么当添加组织机构下发规则时，必须选择A组织机构，不能选择其上下级！',
    note4:
      '4.一条下发规则中设备匹配上的员工将更新调度类别，未匹配上的员工将使用‘默认规则’进行处理。',
    note5:
      '5.默认规则为‘不得进出’，设备未匹配上的人员将被删除；默认规则为‘不限制进出’，设备未匹配上的人员将全天可以进出。',
